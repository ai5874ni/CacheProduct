...
public class CacheServiceImpl implements CacheService {
     ...
     * @param productId
     */
    public ProductInfo getProductInfo2ReidsCache(long productId) {
        String key = "product_info_" + productId;
        String productInfo = jedisCluster.get(key);
     ...
     * @param shopId
     */
    public ShopInfo getShopInfo2ReidsCache(long shopId) {
        String key = "shop_info_" + shopId;
        String productInfo = jedisCluster.get(key);
        return JSONObject.parseObject(productInfo, ShopInfo.class);
    }
